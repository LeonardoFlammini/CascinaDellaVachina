      ...
      <div class="room-main">
        <div class="room-info">
          <section class="section">
            <h2>Descrizione</h2>
            <p>
              La Camera Elena si distingue per i suoi arredi raffinati e l'atmosfera elegante. 
              Progettata per offrire il massimo comfort, questa camera doppia è ideale per chi cerca 
              un'esperienza di soggiorno di classe in un ambiente rilassante e curato nei minimi dettagli.
            </p>
          </section>
...
const roomImages = computed(() => {
  return Object.entries(imageModules)
    .map(([path, url]) => {
      ...
      return {
        src: `/images/rooms/elena/${filename}`,
        alt: `Camera Elena - ${filename}`,
