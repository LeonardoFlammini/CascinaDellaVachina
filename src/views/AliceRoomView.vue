      ...
      <div class="room-main">
        <div class="room-info">
          <section class="section">
            <h2>Descrizione</h2>
            <p>
              La Camera Alice è una camera briosa e luminosa che conquista con la sua atmosfera 
              allegra e accogliente. Perfetta per coppie che cercano un ambiente vivace e confortevole, 
              questa camera offre tutti i comfort moderni con un tocco di personalità che la rende unica.
            </p>
          </section>
...
const roomImages = computed(() => {
  return Object.entries(imageModules)
    .map(([path, url]) => {
      ...
      return {
        src: `/images/rooms/alice/${filename}`,
        alt: `Camera Alice - ${filename}`,
