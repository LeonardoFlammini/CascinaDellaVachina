      ...
      <div class="room-main">
        <div class="room-info">
          <section class="section">
            <h2>Descrizione</h2>
            <p>
              La Camera Giovanna è una camera briosa e luminosa, perfetta per coppie che desiderano 
              un ambiente vivace e accogliente. Con i suoi colori allegri e la luce naturale che 
              pervade gli spazi, questa camera offre un'atmosfera piacevole e rilassante per il vostro soggiorno.
            </p>
          </section>
          ...
          <section class="section">
            ...
            <div class="amenities-list">
              ...
              <span class="amenity">Bagno finestrato</span>
...
// Carica dinamicamente tutte le immagini dalla cartella giovanna
const imageModules = import.meta.glob('/public/images/rooms/giovanna/*.{jpg,jpeg,png,webp}', { eager: true, query: '?url', import: 'default' })
