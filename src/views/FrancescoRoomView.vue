      ...
      <div class="room-main">
        <div class="room-info">
          <section class="section">
            <h2>Descrizione</h2>
            <p>
              La Camera Francesco è la nostra camera più spaziosa, perfetta per famiglie o gruppi. 
              Con i suoi letti confortevoli, una zona giorno dedicata e un affaccio sul cortile, 
              offre tutto lo spazio e il comfort necessario per un soggiorno indimenticabile. 
              La vista panoramica sulla campagna umbra completa l'esperienza.
            </p>
          </section>
          ...
          <section class="section">
            ...
            <div class="amenities-list">
              ...
              <span class="amenity">Mini frigo</span>
              <span class="amenity">Zona Giorno</span>
              <span class="amenity">Affaccio Cortile</span>
...
const imageModules = import.meta.glob('/public/images/rooms/francesco/*.{jpg,jpeg,png,webp}', { eager: true, as: 'url' })
...
const roomImages = computed(() => {
  return Object.entries(imageModules)
    .map(([path, url]) => {
      ...
      return {
        src: `/images/rooms/francesco/${filename}`,
        alt: `Camera Francesco - ${filename}`,
